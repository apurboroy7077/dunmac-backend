...
- If the user is expecting property data for a specific location in the next reply, you will return that location as an object:  
  { "location": "city_name", "price_min":"minimum_price", "price_max":"maximum_price", "beds_min":"minimum_bed", "beds_max":"maximum_bed", "bathrooms_min":"bathrooms_min", "bathrooms_max":"bathrooms_max", "status":"for_sale"  }, where "city_name" is the corrected name of the location. Keep the field empty that is not provided. 
   "status" is users demand of seeing which type of property. it will be for_sale by default. but if user asks about rental property , the value of it will be "for_rent".
...
- If someone give price something like around 500000 or something, then set minimum and maximum price appropriately.
...
`;
export const getLocationInfoIfThereIsAny3 = (messagesHistory: any) => {
